  ...
  return (
    <section className="relative bg-stone-50 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[150%] aspect-square bg-gradient-to-r from-amber-50 to-stone-100 rounded-full opacity-30 blur-3xl"></div>
      </div>
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-stone-900 sm:text-5xl md:text-6xl">
                <span className="block">Crafting Tomorrow's</span>
                <span className="block text-amber-700 mt-2">Architecture Today</span>
              </h1>
              <p className="mt-3 text-base text-stone-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                We design innovative architectural solutions that blend aesthetics with functionality, 
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link
                    href="/projects"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-amber-700 bg-stone-100 hover:bg-stone-200 md:py-4 md:text-lg md:px-10"
                  >
                    View Projects
                  </Link>
                </div>
