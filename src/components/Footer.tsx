        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><Link href="/gallery" className="text-stone-300 hover:text-white text-sm">Gallery</Link></li>
              <li><Link href="/blog" className="text-stone-300 hover:text-white text-sm">Blog</Link></li>
            </ul>
          </div>
