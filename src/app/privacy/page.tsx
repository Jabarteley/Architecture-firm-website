  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          We may collect personal information such as your name, email address, phone number, and other contact details when you submit inquiries through our contact forms or subscribe to our newsletters.
        </p>
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">How We Use Your Information</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          We use the information we collect to respond to your inquiries, provide you with requested services, send you marketing communications, and improve our website and services.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          This Privacy Policy is subject to change without prior notice. Please review it periodically.
        </p>
      </div>
    </div>
  );
