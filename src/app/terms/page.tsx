  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          By using our website, you agree to these Terms of Service, as well as our Privacy Policy. If you do not agree to these terms, please do not use our website.
        </p>
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Changes to Terms</h2>
        <p className="text-gray-700 leading-relaxed mb-4">
          We reserve the right to modify or revise these Terms of Service at any time. Your continued use of the website after any such changes constitutes your acceptance of the new Terms of Service.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          These Terms of Service are subject to change without prior notice. Please review them periodically.
        </p>
      </div>
    </div>
  );
