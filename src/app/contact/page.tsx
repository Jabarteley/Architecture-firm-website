      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16">
            <div>
              <h2 className="text-2xl font-bold text-primary-deep-brown">Contact Information</h2>
              <p className="mt-4 text-primary-dark-brown">
              ...
              <div className="mt-10">
                <h3 className="text-lg font-medium text-primary-deep-brown">Follow Us</h3>
                <div className="mt-4 flex space-x-6">
                  <a href="#" className="text-primary-dark-brown hover:text-primary-deep-brown">
              ...
              <div className="bg-primary-light-brown py-8 px-6 sm:py-10 sm:px-10 rounded-lg shadow-md">
                ...
                {searchParams.success === 'true' ? (
                  ...
                  <form action={handleSubmit} className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    <div>
                      <label htmlFor="name" className="block text-sm font-medium text-primary-deep-brown">
                        Name *
                      </label>
                      <div className="mt-1">
                        <input
                          ...
                          id="name"
                          required
                          className="py-3 px-4 block w-full shadow-sm text-primary-deep-brown focus:ring-amber-500 focus:border-amber-500 border-primary-dark-brown rounded-md"
                        />
                      </div>
                    </div>

                    <div>
                      <label htmlFor="email" className="block text-sm font-medium text-primary-deep-brown">
                        Email *
                      </label>
                      <div className="mt-1">
                        <input
                    ...
                    <div>
                      <label htmlFor="phone" className="block text-sm font-medium text-primary-deep-brown">
                        Phone
                      </label>
                      <div className="mt-1">
                        <input
                    ...
                    <div className="sm:col-span-2">
                      <label htmlFor="message" className="block text-sm font-medium text-primary-deep-brown">
                        Message *
                      </label>
                      <div className="mt-1">
                        <textarea
                    ...
                    <div className="sm:col-span-2">
                      <button
                        type="submit"
                        className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-dark-brown hover:bg-primary-deep-brown focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500"
                      >
                        Send Message
                      </button>
                    </div>
