        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-stone-600">+1 (555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-stone-600">info@architecturefirm.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-stone-900">Office</h3>
              ...
              <div className="mt-10">
                <h3 className="text-lg font-medium text-stone-900">Follow Us</h3>
            ...
            <div className="mt-12 lg:mt-0">
              <div className="bg-stone-50 py-8 px-6 sm:py-10 sm:px-10">
